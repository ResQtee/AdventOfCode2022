using AdventOfCode.Puzzles.Day_03;
...
public class Day03
{
    public static void Print()
    {
        ...
        var rucksacks = new RucksacksInventoryList().FillRucksacks(@".\day 03\input\example.txt");
        ...
        rucksacks = new RucksacksInventoryList().FillRucksacks(@".\day 03\input\puzzle.txt");
