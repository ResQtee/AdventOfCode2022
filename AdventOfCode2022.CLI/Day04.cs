using AdventOfCode.Puzzles.Day_04;
...
public class Day04
{
    public static void Print()
    {
        ...
        var sectionAssignments = Assignments.GiveAssignmentsFromFile(@".\day 04\input\example.txt");
        ...
        sectionAssignments = Assignments.GiveAssignmentsFromFile(@".\day 04\input\puzzle.txt");
