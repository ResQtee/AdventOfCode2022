using AdventOfCode.Puzzles.Day_08;
...
public class Day08
{
    public static void Print()
    {
        ...
        var treeMap = RasterisedTreeMap.ReadFromFile(@".\day 08\input\example.txt");
        ...
        treeMap = RasterisedTreeMap.ReadFromFile(@".\day 08\input\puzzle.txt");
        Console.WriteLine($"Answer: {treeVisibility.FindAllVisibleTrees(treeMap)} trees.");
