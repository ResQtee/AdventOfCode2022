using AdventOfCode.Puzzles.Day_09;
...
public class Day09
{
    public static void Print()
    {
        ...
        var rope = new Rope();
        var instructions = reader.Read(@".\day 09\input\example.txt");
        ...
        rope = new Rope(10);
        instructions = reader.Read(@".\day 09\input\example2.txt");
        foreach (var instruction in instructions)
        {
            rope.MoveFirstKnot(instruction.direction, instruction.distance);
        }
        ...
        rope = new Rope(2);
        instructions = reader.Read(@".\day 09\input\puzzle.txt");
        foreach (var instruction in instructions)
        {
            rope.MoveFirstKnot(instruction.direction, instruction.distance);
        }
